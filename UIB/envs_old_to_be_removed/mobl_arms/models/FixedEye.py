...
class FixedEye(ABC, gym.Env):
  ...
  # Model file
  xml_file = os.path.join(project_path(), "envs_old_to_be_removed/mobl_arms/rl/variants/mobl_arms_muscles_v2_modified.xml")
  ...
  def get_observation(self):
    ...
    if self.render_observations:
      # Get vision observation and normalize
    ...
    return {'proprioception': proprioception, 'vision': visual}
