...
from UIB.envs_old_to_be_removed.mobl_arms.remote_driving.reward_functions import NegativeExpDistance, RewardBonus
...
class RemoteDrivingEnv(FixedEye):
  ...
  # Model file
  #xml_file = os.path.join(project_path(), "envs_old_to_be_removed/mobl_arms/rl/variants/mobl_arms_muscles.xml")
  ...
  def __init__(self, direction="vertical", **kwargs):
    ...
    #include_car_scene = ET.Element('include',  file=os.path.join(project_path(), 'envs_old_to_be_removed/mobl_arms/remote_driving/rl/scene.xml'))
    #root.append(include_car_scene)

    # Include additional xml files
    xml_file_car_scene = os.path.join(project_path(), 'envs_old_to_be_removed/mobl_arms/remote_driving/rl/scene_complete.xml')
    ...
    xml_file = os.path.join(project_path(), 'envs_old_to_be_removed/mobl_arms/rl/variants/remote_driving_env.xml')
