...
- CalculateReward():
	...
	To be compatible with the effort term added by the biomechanical model, the reward should be in range [-x,x] %TODO: find x
- Reset():
...
5. Build your application into the directory "\user-in-the-box\uitb\tasks\unity" 
